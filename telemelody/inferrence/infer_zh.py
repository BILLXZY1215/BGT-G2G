...
if __name__ == '__main__':
    ...
    with open(f'data/zh/{data_prefix}/lyric.txt', 'r', encoding='utf-8') as f, open(f'data/zh/{data_prefix}/chord.txt', 'r', encoding='utf-8') as c:
        for song, sents in enumerate(tqdm(list(zip(f, c)))):
            sents, bar_chords = sents
            sents = sents.strip()
            syllables = sents
            ...
            midi_obj.dump(f'results/{prefix}/midi/{song}.mid', charset='utf-8')
